 ...
 */
class AuditWindmillBladeAdminController extends Controller
{
    /**
    ...
    protected function redirectTo($object)
    {
        ...
        if (null !== $request->get('btn_update_and_list')) {
            ...
            $url = $router->generate('admin_app_audit_edit', array('id' => $object->getAudit()->getId()), UrlGeneratorInterface::ABSOLUTE_PATH);
        }

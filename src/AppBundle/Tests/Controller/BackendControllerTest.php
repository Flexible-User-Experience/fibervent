...
class BackendControllerTest extends AbstractBaseTest
{
    ...
    public function provideSuccessfulUrls()
    {
        return array(
            ...
            array('/admin/windfarms/windmill/turbine/list'),
            array('/admin/windfarms/windmill/turbine/create'),
            array('/admin/windfarms/windmill/turbine/1/delete'),
            array('/admin/windfarms/windmill/turbine/1/edit'),

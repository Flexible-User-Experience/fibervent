...
class BackendControllerTest extends AbstractBaseTest
{
    ...
    public function provideSuccessfulUrls()
    {
        return array(
            ...
            array('/admin/windfarms/windmillblade/list'),
            array('/admin/windfarms/windmillblade/create'),
            array('/admin/windfarms/windmillblade/1/delete'),
            array('/admin/windfarms/windmillblade/1/edit'),
            ...
            array('/admin/audits/audit/1/pdf'),
